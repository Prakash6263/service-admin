...
//   const imageUrl = src?.startsWith("http") ? src : `https://api.mrbikedoctor.cloud/uploads/${src}`
...
//                         <ImagePreview
//                           key={index}
//                           src={`https://api.mrbikedoctor.cloud/uploads/dealer-documents/${img}`}
...
//                       <ImagePreview
//                         src={`https://api.mrbikedoctor.cloud/uploads/dealer-documents/${dealer.documents?.aadharFront}`}
//                         label="Aadhaar Front"
//                       />
//                       <ImagePreview
//                         src={`https://api.mrbikedoctor.cloud/uploads/dealer-documents/${dealer.documents?.aadharBack}`}
//                         label="Aadhaar Back"
//                       />
//                     </div>
//                     <div className="col-md-4">
//                       <ImagePreview
//                         src={`https://api.mrbikedoctor.cloud/uploads/dealer-documents/${dealer.documents?.panCardFront}`}
//                         label="PAN Card"
//                       />
//                     </div>
//                   </div>
...
//                                           {service.image && (
//                                             <ImagePreview
//                                               src={`https://api.mrbikedoctor.cloud/uploads/${service.image}`}
//                                               label=""
  ...
  const downloadDealerPDF = async () => {
    ...
    if (Array.isArray(dealer.shopImages) && dealer.shopImages.length > 0) {
      ...
      for (let i = 0; i < Math.min(dealer.shopImages.length, 4); i++) {
        const imgUrl = `https://api.mrbikedoctor.cloud/uploads/dealer-documents/${dealer.shopImages[i]}`
